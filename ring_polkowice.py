...
def ring_bin_all(time_step=50, deck_name="simulation_0.dem"):
...
def ring_bin_lupek(time_step=50, deck_name="simulation_0.dem"):
...
def ring_bin_piaskowiec(time_step=50, deck_name="simulation_0.dem"):
...
def ring_bin_dolomit(time_step=50, deck_name="simulation_0.dem"):
